...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_json', type=str,
                        default='/tmp/', help='writing output json dir')
    ...
    image = TfPoseEstimator.draw_humans(
        image, humans, imgcopy=False, frame=0, output_json_dir=args.output_json)
